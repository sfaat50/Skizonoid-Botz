...
exports.firstChat = (a, b, c) =>{
	return`Selamat ${a} ${b} 💀, Hai masbro saya ${c} yaitu bot whatsapp. Ada yang bisa ${c} bantu?`
	}
exports.StartAbsen = () =>{
	return`Mulai Absen`
	}
...
exports.JwbErr = () => {
    return `❌ Jawaban mu Salah Gblk `
}

exports.JwbTrue = (tebak, exp) => {
return`🎮 ${tebak} 🎮\n\nHore Jawaban Mu Benar Ngab 🎉\n+${exp} XP`
}
exports.TbGam = () => {
    return `Tebak Gambar`
}
...
exports.menunya = (salam, pushname, botname) =>{
	return`Hai Kak/Bro ${pushname} 👋 selamat ${salam} , 
...
exports.welcome = () =>{
	return`𝖩𝖺𝗇𝗀𝖺𝗇 𝗅𝗎𝗉𝖺 𝗂𝗇𝗍𝗋𝗈 Bro/Kak 💀
	
╭ 𝖭𝖺𝗆𝖺 :
│○ 𝖴𝗆𝗎𝗋 :
│○ 𝖦𝖾𝗇𝖽𝖾𝗋 :
│○ 𝖠𝗌𝗄𝗈𝗍 :
╰❒ 𝖯𝖺𝗍𝗎𝗁𝗂 𝗋𝗎𝗅𝖾𝗌 𝗀𝗋𝗎𝗉 𝗒𝖺 Bro/Kak ~`
}
exports.leave = () =>{
	return`Yah kok out 😣 Mental aman kan Bro ?
Goodbye`
}
exports.source = () =>{
return`*------「 SOURCE CODE 」 ------*

Base : https://kochengblogger.blogspot.com
Recode : https://kochengblogger.blogspot.com
`
}
